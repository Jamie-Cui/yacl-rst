...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🔐 DPF (Distributed Point Function) Demo");
    println!("==========================================");
    ...
    println!("\n🔑 Key Generation:");
    println!("  ✓ Key 0 (Party 0): rank={}, control_words={}", 
             key_0.get_rank(), key_0.cws_vec.len());
    println!("  ✓ Key 1 (Party 1): rank={}, control_words={}", 
             key_1.get_rank(), key_1.cws_vec.len());
    
    // Test evaluation at secret point
    println!("\n🎯 Evaluation at Secret Point:");
    ...
    println!("  ✅ Correct: {}", result.get_val() == beta.get_val());
    ...
    for &point in &test_points {
        ...
        println!("  Point {}: result = {} {}",
                 ...
                 if result.get_val() == 0 { "✅" } else { "❌" });
    }
    
    // Demonstrate full domain evaluation (small domain)
    println!("\n🌐 Full Domain Evaluation (4-bit example):");
